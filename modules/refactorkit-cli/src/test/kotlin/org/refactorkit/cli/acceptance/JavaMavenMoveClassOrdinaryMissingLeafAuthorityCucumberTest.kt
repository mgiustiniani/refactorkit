...
@ConfigurationParameter(key = FILTER_TAGS_PROPERTY_NAME, value = "@REQ-JAVA-MAVEN-MOVE-AUTH-011")
class JavaMavenMoveClassOrdinaryMissingLeafAuthorityCucumberTest
