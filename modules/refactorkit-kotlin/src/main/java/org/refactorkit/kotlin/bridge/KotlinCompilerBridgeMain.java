    ...
    private static String renderSymbols(
        ...
        for (int index = 0; index < symbols.size(); index++) {
            ...
            json.append("{\"identity\":\"").append(escape(symbol.identity()))
                ...
                .append(",\"overrideFamilyId\":\"").append(escape(symbol.overrideFamilyId()))
                .append("\",\"hierarchyMember\":").append(symbol.isHierarchyMember())
                ...
                .append(",\"declarationStartOffset\":").append(symbol.declarationStartOffset())
                .append(",\"declarationEndOffset\":").append(symbol.declarationEndOffset())
                .append(",\"bodyStartOffset\":").append(symbol.bodyStartOffset())
                .append(",\"bodyEndOffset\":").append(symbol.bodyEndOffset())
                .append(",\"simpleIntegerExpressionBody\":").append(symbol.isSimpleIntegerExpressionBody())
                .append(",\"extensionReceiver\":").append(symbol.hasExtensionReceiver())
                .append(",\"suspendFunction\":").append(symbol.isSuspendFunction())
                .append(",\"dataClass\":").append(symbol.isDataClass())
                .append(",\"sealedClass\":").append(symbol.isSealedClass())
                .append(",\"valueClass\":").append(symbol.isValueClass())
                .append(",\"delegatedProperty\":").append(symbol.isDelegatedProperty())
                .append(",\"jvmNameEffect\":").append(symbol.hasJvmNameEffect())
                .append(",\"externalHierarchyBoundary\":").append(symbol.hasExternalHierarchyBoundary())
