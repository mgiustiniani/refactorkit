...
class KotlinPrivateTypeRenamePlanner(
    ...
    fun preview(snapshot: ProjectSnapshot, symbolId: SymbolId, newName: String): PatchPlan {
        ...
        if (target.kind !in TYPE_KINDS) return refused(
            snapshot, "kotlin.renameKindUnsupported", "Initial Kotlin rename supports compiler-proven types only",
        )
        ...
        return PatchPlan(
            ...
            warnings = listOf("K4 bootstrap row: Kotlin-only private type; apply authority remains transport-gated."),
    ...
    companion object {
        ...
        private val TYPE_KINDS = setOf(Symbol.Kind.CLASS, Symbol.Kind.INTERFACE, Symbol.Kind.OBJECT, Symbol.Kind.ENUM, Symbol.Kind.ANNOTATION)
