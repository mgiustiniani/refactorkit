 ...
 *
 * Slice glue-shared-refusal-r002 (migration to shared refusal glue): the five Scenario 2
 ...
 * KotlinJvmRefusalScenarioContext port). previewInlineMethod publishes the produced plan
 ...
 */
class KotlinJvmInlineMethodRefusalSteps(private val context: KotlinJvmRefusalScenarioContext) {
