 ...
 *
 * GLUE is scoped to org.refactorkit.jvm.hierarchypushdown plus the shared refusal glue
 * package org.refactorkit.jvm.refusals (slice glue-shared-refusal-r004), which carries the
 * refusal-inspection steps over the scenario-scoped KotlinJvmRefusalScenarioContext port.
 * The leaf package stays distinct from the other refusal slices
 * (org.refactorkit.jvm.hierarchypullup, org.refactorkit.jvm.inlinerefusal and
 * org.refactorkit.jvm.inlinemethodrefusal) so the remaining leaf step regexes of the refusal
...
@ConfigurationParameter(key = GLUE_PROPERTY_NAME, value = "org.refactorkit.jvm.hierarchypushdown,org.refactorkit.jvm.refusals")
