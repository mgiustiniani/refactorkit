 ...
 */
class KotlinJvmHierarchyPullUpRefusalSteps {
    ...
    fun callerInspectsRefusalPlan() {
        requireNotNull(plan) { "expected a REFUSED pullUpMember plan to inspect" }
    }
    ...
    fun refusalGrantsNoManagedWriteEligibility() {
        ...
        // the REFUSED pullUpMember plan must carry none and must not be an actionable apply.
        assertEquals(PatchStatus.REFUSED, p.status, p.toString())
