...
| `refactorkit-kotlin`      | 🚧 v0.7     | Explicit JDK/compiler discovery, hash-bound Kotlin/JVM projection, bounded external K2 diagnostics, and compiler-proven class/interface/enum/annotation search/definition; references and mutations remain refused |
