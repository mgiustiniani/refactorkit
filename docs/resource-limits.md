...
| Kotlin K2 diagnostics and declaration symbols | 30 seconds, 512 MiB compiler heap, 8 MiB stdout, 64 KiB stderr, 1 process, 96 `.kt` files, 128 project classpath entries, 500 diagnostics, 500 compiler symbols, 2,000 resolved function usages, 16 MiB and 10,000 non-synthetic methods/generated callable-owner class, 1,024 characters/JVM descriptor, 4,096 characters/diagnostic message, 512 UTF-16 units/symbol name | Typed refusal/error; process tree terminated, no partial diagnostics or symbol index promoted; protocol symbol output remains capped at 200 with explicit truncation |
