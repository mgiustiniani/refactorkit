...
with tempfile.TemporaryDirectory(prefix='rpk-nested-alias-class-') as td:
 ...
 files={
 'src/main/kotlin/source/lib/Alias.kt':'package source.lib\ntypealias Chosen = java.util.concurrent.TimeUnit\n',
 'src/main/kotlin/other/shadow/Chosen.kt':'package other.shadow\nclass Chosen\n',
