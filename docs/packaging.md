...
provenance attestation, and SBOM attestation. `v0.5.0` publishes and natively
accepts the complete four-platform matrix.
...
For `v0.5.0`, select the matching platform pair, for example:
...
```text
/tmp/refactorkit-v0.5.0/refactorkit/
  bin/refactorkit
  runtime/bin/java
```
