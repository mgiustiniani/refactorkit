...
REQUIRED_TESTS = {
    ...
    "publicTopLevelKotlinFunctionMoveRefusesTypeAliasBindingSubstitution()",
    ...
    "publicTopLevelKotlinFunctionMoveRefusesCallableReferenceConsumer()",
...
SUBJECT_FILES = {
    ...
    Path("docs/requirements/kotlin-jvm-move-top-level-function-and-companion-refusal-approved-change-004.md"),
    Path("docs/requirements/kotlin-jvm-move-top-level-function-and-companion-refusal-approved-change-005.md"),
    Path("docs/requirements/kotlin-jvm-move-top-level-function-and-companion-refusal-approved-change-006.md"),
    ...
    Path("docs/requirements/evidence/probe-k5-move-callref-consumer-e22627fc83fe9d37b9d0d3e5bc68b9ec8799993dbab09d193304be9dbbb6020a.py"),
    Path("docs/requirements/evidence/kotlin-jvm-move-callable-consumer-24-case-green-284ee50479b6f95c00958c2f3cbd190e84be33b868e5b42c1938adcdedd80bad.log"),
    ...
    Path("docs/requirements/evidence/probe-a8822-move-typealias-rebound-df8947bf38df4fb7699be2de9bb13265d334804fe7003840c034de3901cb8aaa.py"),
    Path("docs/requirements/evidence/probe-a8822-maven-xplugin-move-cc04cc67a245fcde1fd35312ce79ebb76dc9c78d6a2de50a1e3a1b6ea7d02a84.py"),
    Path("docs/requirements/evidence/kotlin-jvm-move-typealias-xplugin-25-case-green-ca1357ef0569e6010d4184441e1c44abd2263a227bb03cc43637929a06572927.log"),
    ...
    Path("docs/requirements/evidence/kotlin-jvm-move-nested-typealias-25-case-green-35a6d9aedeeef64f59af39b2605ebee2b60724bb75ea137a85999edd560f4e39.log"),
...
def main() -> int:
    ...
    receipt = {
        ...
        "boundaries": [
            ...
            "Java, alias, direct/nested typealias, star, same-package, qualified, callable-reference, overload, extension, suspend, default, JVM-name, multifile, generated, and plugin-dependent function forms remain refused.",
